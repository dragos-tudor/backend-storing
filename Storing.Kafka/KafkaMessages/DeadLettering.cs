...
partial class KafkaFuncs
{
    ...
    string? reason = default)
  {
    ...
    headers = SetKafkaHeaderString(headers, OriginalPartitionHeaderName, consumeResult.Partition.Value.ToString());
    headers = SetKafkaHeaderString(headers, OriginalOffsetHeaderName, consumeResult.Offset.Value.ToString());
