...
partial class KafkaFuncs
{
  public static KafkaOptions CreateKafkaOptions(
    ...
    => new()
    {
      ...
      ConsumeTimeout = consumeTimeout ?? TimeSpan.FromSeconds(1),
  ...
  public static KafkaOptions CreateKafkaOptionsFromEnvironment(
    ...
    string consumeTimeoutMillisecondsName = "KAFKA_CONSUME_TIMEOUT_MS",
    ...
    string deadLetterTopicSuffixName = "KAFKA_DLQ_SUFFIX")
  {
    ...
    var consumeTimeout = TimeSpan.FromMilliseconds(ParseKafkaInt(Environment.GetEnvironmentVariable(consumeTimeoutMillisecondsName), 1000));
